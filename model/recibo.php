...
class Recibo
{
    ...
    public $Estatus;//cobrado, pendiente, inactivo, incobrable
    ...
    public function Listar()
    {
        try
        {
            ...
            $stm = $this->pdo->prepare("SELECT * FROM recibos");
            $stm->execute();
    ...
    public function Obtener($id)
    {
        try
        {
            $stm = $this->pdo->prepare("SELECT * FROM recibos WHERE id = ?");
    ...
    public function Eliminar($id)
    {
        try
        {
            $stm = $this->pdo->prepare("DELETE FROM recibos WHERE id = ?");
            $stm->execute(array($id));
        }
        catch(Exception $e)
        {
    ...
    public function Generar(int $typeGenerator)
    {
        //1 Auto
        //2 By user
        //tis is for automatic generation by date
    }
